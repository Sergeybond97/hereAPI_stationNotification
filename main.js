...
// Create an marker object at a specific geographic location:
var testMarker = new H.map.Marker({ lat: 55.753058, lng: 37.626213 });
map.addObject(testMarker);


function addDraggableMarker(map, behavior){

	var marker = new H.map.Marker({lat: 55.753058, lng: 37.626213});
...
function findMyPos() {  // Function for finding user's position
	...
	return pos;
  	...
  	myPosition = findMyPos(); // Find user's position
